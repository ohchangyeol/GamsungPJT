							...
							<section class="panel">
								...
								<div class="panel-body">
									...
									<script>
										...
										// See: resources/js/dashboard/examples.dashboard.js for more settings.
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="resources/images/!logged-user.jpg">
												</div>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="resources/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src="resources/images/projects/project-4.jpg">
																<span class="zoom">
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src="resources/images/!sample-user.jpg" alt="Joseph Doe" class="img-circle">
										</figure>
										<div class="profile-info">
