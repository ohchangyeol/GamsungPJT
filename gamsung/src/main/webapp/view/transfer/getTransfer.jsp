...
.form-group div.ohcamp input, div {
	flex: 3;
}
			...
			<section class="module" style="padding: 20px">
				<div class="container">
							...
							<div class="col-sm-12 minititle">
								...
								<div class="col-sm-6">
									...
									<div class="form-group a transferminititle">
										...
										<div class="ohcamp transferminititle">${transfer.transferUserNum}&ensp;명</div>
									</div>
							...
							<div class="col-sm-12">
								...
								<div class="col-sm-7">
									...
									<div class="submit" id="submit">
										...
										<button type="button" name="receivebutton"
											class="receivebutton"
								...
								<div
									class="minititle transferpayment col-sm-5 transferminititle">
									<h3>예약양도결제내역</h3>
					...
					<div class="container receive">
						<div class="col-sm-12">
							<h3 class="mb-0" style="font-family: 'Noto Sans KR', sans-serif;">양수신청목록(신청자는 본인의 양수신청내역만 조회하실 수 있습니다.)</h3>
								...
								<div class='receivelist'>
									...
									<div class='receive'>
										<div class="a">
											...
											<div>
												<span class="receiveminititle" style="color: steelblue;">작성자ID&nbsp;</span> <span>${receive.transferee.id}</span>
												<span class="receiveminititle" style="color: steelblue;">핸드폰번호&nbsp;</span> <span>${receive.receivePhone}</span>
											</div>
							...
							<form name="receiveform" id="receiveform" role="form">
								<div class="col-sm-12">
									...
									<div class="col-sm-12"
										...
										<h4 class="mb-0"
											style="font-family: 'Noto Sans KR', sans-serif;">예약양도 신청</h4>
										<hr class="divider-w mt-10 mb-20">

										<input id="receiveTitle" name="receiveTitle"
											class="form-control" type="text" placeholder="제목을 등록해주세요."
