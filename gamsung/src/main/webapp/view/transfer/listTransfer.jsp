...
<!--             </div> -->
                                    ...
                                    <form role="form" class="transfer-search" method="post">
                                       <div class="col-sm-4">
                                          ...
                                          <select id="searchCondition" class="form-control" name="searchCondition">
                                             <option value="0" ${ ! empty search.searchCondition && search.searchCondition==0 ? "selected" : "" }>금액별</option>
                                             <option value="1" ${ ! empty search.searchCondition && search.searchCondition==1 ? "selected" : "" }>기간검색</option>                          
                                          </select>
                                       </div>
 ...
 <div class="search-box layer" >
  <select class='form-control' style="width: 280px;" name='searchKeyword'  id='campNo' style='width: 499px'>
...
<option value="5">40만원이상</option>  
                                          ...
                                          <div style=" display: flex; ">
                                             <input class="form-control" type="text" placeholder="YYYYMMDD(입실)" name="searchKeyword" value="${search.searchKeyword}"> 
                                             <div>&nbsp;~&nbsp;</div>                             
                                             <input class="form-control" type="text" placeholder="YYYYMMDD(퇴실)" name="searchKeyword" value="${search.searchKeyword}">
