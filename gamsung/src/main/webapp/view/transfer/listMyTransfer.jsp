												...
												<form role="form" class="post-search">
													...
													<div class="col-sm-2 form-check"
														...
														<input type="radio" class="btn-check" name="options-outlined"
															id="transfer-outlined" autocomplete="off"
															onclick="transfercheck();" checked> <label
															class="btn btn-outline-success" style="padding: 0px;"
															for="success-outlined">양도</label>
													...
													<div class="col-sm-2 form-check"
														...
														<input type="radio" class="btn-check" name="options-outlined"
															id="receive-outlined" autocomplete="off"
															onclick="receivecheck()"> <label
															class="btn btn-outline-success" style="padding: 0px;"
															for="success-outlined">양수</label>
															...
															<tbody style="color: #2d2d2d; font-size: 11px;">
																...
																<c:forEach var="transfer" items="${Transferlist}">
																	...
																	<tr class="transfer" value="${transfer.transferNo}"
																		style="cursor: pointer; text-align: center; color: #0c0c4f">
																		<!--양도글번호-->
																		<td class="col-sm-1 center transferno"
																			id="${transfer.transferNo}">
																		...
																		<!--제목-->
																		<td class="col-sm-3">${transfer.transferTitle}
																		</td>

																		<!--양도금액-->
																		<td class="col-sm-1" id="price">
																			${transfer.transferPrice}원</td>

																		<!-- 등록일자 -->
																		<td class="col-sm-1" name="date">
																			${transfer.transferRegdate}</td>
									...
									list.forEach(el => { //el이 이 list의 하나 하나 하나 하나 하나
										...
										if (el.receiveStatus == 2) {
											...
											tbody_tr += "<div>" +
												...
												"<button type='button' id ='payment" + el.receiveNo + "' class='btn btn-success btn-xs' data-transferor=" + el.transferOr.id + " data-transferprice = " + el.transferPrice + " data-transferno=" + el.transferNo + " style='height: 21px; color: #fff;'>" +
										...
										$("#payment" + el.receiveNo).on("click", function () {
											...
											if ((havingPoint - transferPrice) < 0) {
												...
												if (confirm("해당 양도금액만큼 포인트가 차감됩니다.")) {
													...
													window.location = "/transfer/TransferPayment?transferor=" + transferor + "&transferPrice=" + transferPrice + "&transferno=" + transferno;
