		...
		<div class="collapse navbar-collapse" id="custom-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle" href="#"
					...
					</ul> <!-- 예시 End --> <!-- 중고경매 Start -->
				<li class="dropdown"><a class="dropdown-toggle" href="#"
					data-toggle="dropdown">중고상품</a>
					<ul class="dropdown-menu">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					href="/community/listPost" data-toggle="dropdown">커뮤니티</a>
					<ul class="dropdown-menu">
				...
				<!-- 커뮤니티 End -->
					...
					<!-- 양도양수 Start -->
				<li class="dropdown"><a class="dropdown-toggle"
					href="/servicecenter/home" data-toggle="dropdown">예약양도양수</a>
					<ul class="dropdown-menu">
				...
				<!-- 고객센터 Start -->
				<li class="dropdown"><a class="dropdown-toggle"
					href="/servicecenter/home" data-toggle="dropdown">고객센터</a>
					<ul class="dropdown-menu">
				...
				<c:if test="${user.role != 'BUSINESS' && sessionScope.user != null}">
					<li class="dropdown"><a class="dropdown-toggle"
						href="/user/mypage" data-toggle="dropdown">${user.nickName}<br />보유포인트
							: ${user.havingPoint}
					</a>
						<ul class="dropdown-menu">
				...
				<!-- 로그인/로그아웃 End -->
				<li><c:if test="${sessionScope.user.role!=null}">
						<a href="#">
							<button class="btn btn-border-w btn-round btn-xs" type="button"
								id="logout">LOGOUT</button>
						</a>
					</c:if> <c:if test="${sessionScope.user.role==null}">
