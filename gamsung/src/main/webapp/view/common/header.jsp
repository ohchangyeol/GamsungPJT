							...
							<c:if test="${sessionScope.user != null}">
								<li class="dropdown">
									...
									<c:if test="${user.role=='ADMIN'}">
										<a class="dropdown-toggle" href="/admin" data-toggle="dropdown">${user.nickName}
											님</a>
									</c:if>

									<c:if test="${user.role == 'BUSINESS'}">
										<a class="dropdown-toggle" href="/campBusiness/goSubMainCampBusiness"
											data-toggle="dropdown">${user.campName} 님 [사업자]</a>
									</c:if>
									...
									<ul class="dropdown-menu login-dropdown">
										...
										<li>
											...
											<p style="padding-bottom: 10px; border-bottom: 1px #ddd solid;">
												<span id="havingPoint" class="main-color" style="font-weight: 700;">
										...
										<c:if test="${user.role == 'GENERAL'}">
											...
											<li><a href="/community/listMyPost"
											...
											<li><a href="" style="border-bottom: none !important;"><i
														class="fa  fa-refresh" aria-hidden="true"></i>&nbsp;예약양도</a>
											</li>
											<li><a href="/payment/listPayment"
													style="border-bottom: none !important;"><i class="fa fa-money"
														aria-hidden="true"></i>&nbsp;결제 내역</a></li>
											<li><a href="/payment/managePoint"
													style="border-bottom: none !important;"><i class="fa fa-money"
														aria-hidden="true"></i>&nbsp;포인트 관리</a></li>
										</c:if>

										<li><a href="/user/logout"><button class="btn btn-border-w btn-round btn-xs"
													type="button" id="logout"
													style="border: none;padding: 5px 0 5px 0;width: 100%;font-size: 13px;text-align: left;color: #999; border-top:1px #ddd solid"><i
														class="bi bi-box-arrow-right" style="font-size: 20px;
                              "></i>&nbsp;로그아웃</button></a></li>
