									...
									<ul class="dropdown-menu login-dropdown">
										...
										<li>
											...
											<p style="padding-bottom: 10px; border-bottom: 1px #ddd solid;">
												<span id="havingPoint" class="main-color"
													style="font-weight: 700;">${user.havingPoint} </span>p
											</p>
										</li>
										...
										<li><a href="/user/logout" style="border-bottom: none !important;"><button
										...
										<ul class="dropdown-menu login-dropdown">
											...
											<c:if test="${user.role != 'ADMIN'}">
												...
												<li><a href="" style="border-bottom: none !important;"><i
															class="bi bi-truck">&nbsp;</i>캠핑장</a></li>
												<li><a id="auctionAdd" style="border-bottom: none !important;"><i
															class="fa fa-gavel" aria-hidden="true"></i>&nbsp;중고경매</a>
												</li>
												<li><a href="" style="border-bottom: none !important;"><i
															class="fa  fa-refresh" aria-hidden="true"></i>&nbsp;예약양도</a>
												</li>
