  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60" style="background: #fff">
    <main>
     ...
     <!--addPost Start-->   
	    		...
	    		<h2 class="module-title font-alt " style="color: #9a9696; text-align: inherit; position:inherit" >게시글 수정</h2>
		...
		<input type="hidden" id="concernType" name="concernType" value="${post.concernType}"/>				
         ...
         <div class="form-group">
           ...
           <input class="form-control" type="text" id="postTitle" name="postTitle" value="${post.postTitle}" required="required" />
           <p class="help-block text-danger"></p>
         </div>

         <div class="form-group">
           <label class="sr-only" for="content">내용</label>
           <textarea class="form-control" id="postContent" name="postContent" required="required" style="height: 514px">${post.postContent}</textarea>
           <p class="help-block text-danger"></p>
         </div>

         <div class="form-group">
           <label class="sr-only" for="hashtag">해시태그</label>
           <input class="form-control" type="text" id="allhashtag" name="allhashtag" value="${post.hashtag1}${post.hashtag2}${post.hashtag3}"></input>
           <p class="help-block text-danger"></p>
         </div>
