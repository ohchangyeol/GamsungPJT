            ...
            <section class="body">
              ...
              <div class="row" style="padding-top: 20px;">
                <div calss="col-sm-12" style="text-align: center; font-size: x-large; margin-bottom: 10px;">
                  <span class="icon-happy"></span>&nbsp;내가 쓴 게시글&nbsp;<span class="icon-happy"></span>
                </div>
                <div class="col-xs-12">
                  <div class="row">
                            ...
                            <table class="table table-hover mb-none">
                              ...
                              <tbody>
                                ...
                                <c:forEach var="post" items="${list}">
                                  ...
                                  <tr class="commu_post" value=${post.postNo}
                                    style="cursor: pointer; text-align: center;">
                                    <td class="col-sm-1 center">${ i }</td>
                                    <td class="col-sm-2">${post.postType}</td>
                                    <td class="col-sm-7">${post.postTitle}</td>
                                    <td class="col-sm-2">${post.postRegdate}</td>
                                  </tr>
                                </c:forEach>
                              </tbody>
                            </table>
