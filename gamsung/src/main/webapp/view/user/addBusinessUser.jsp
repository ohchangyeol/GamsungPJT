					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							...
							<form class="form" role="form">
								...
								<div><input id="role" name="role" value="BUSINESS" hidden="hidden"></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input id="tourismBusinessNum" name="tourismBusinessNum" class="form-control" type="text"
											placeholder="숫자만 입력해주세요" maxlength="10"/>
									</div>
								...
								<div class="form-group">
									<label for="addr"
										class="col-sm-offset-1 col-sm-3 control-label"><strong>캠핑장 주소</strong></label>
									<div class="col-sm-6">
				...
				5					<div class="col-sm-6">
					...
					<div class="col-sm-3 col-sm-offset-2">
						<div class="row">
							...
							<button id="joinAddUser" class="btn btn-border-d btn-circle" type="submit">가입 요청하기</button>
