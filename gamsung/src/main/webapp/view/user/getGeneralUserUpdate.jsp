							...
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									...
									<form class="form" role="form">
										...
										<c:if
											test="${sessionScope.user.role=='ADMIN'} && ($(this).text().trim().secessionRegDate != null || $(this).text().trim().suspensionDate !=null)">
											...
											<div id="" class="form-group">
												<label for=""
													class="col-sm-offset-1 col-sm-3 control-label"><strong>이용정지
														일자</strong></label>
												<div class="col-sm-6">
													<input id="" name="suspensionDate" class="form-control" type="text"
														value="${$(this).text().trim().suspensionDate}" readonly />
												</div>
											</div>
										</c:if>
									</form>
