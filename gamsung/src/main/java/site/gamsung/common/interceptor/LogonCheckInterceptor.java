...
public class LogonCheckInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(	HttpServletRequest request,
		...
		if(   user != null   )  {
			...
			//==> 로그인 시도 중.....			
			if(		uri.indexOf("addUser") != -1 || uri.indexOf("login") != -1 || uri.indexOf("checkIdPassword") != -1 ||  uri.indexOf("checkDuplication") != -1 || uri.indexOf("findId") != -1 || uri.indexOf("checkDuplication") != -1
					...
					|| uri.indexOf("listWaitAuctionProduct") != -1 || uri.indexOf("listAuctionProduct") != -1 || uri.indexOf("video") != -1){
